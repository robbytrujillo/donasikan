            ...
            >
              ...
              <div class="flex flex-col gap-[6px]">
                <a
                  ...
                  >Makanan Bergizi Warga Terdampar</a
                >
            ...
            >
              ...
              <div class="flex flex-col gap-[6px]">
                <a
                  href="details.html"
                  class="font-bold line-clamp-2 hover:line-clamp-none"
                  >Bangun Panti Asuhan 10,000 Yatim Piatu</a
                >
                <p class="text-xs leading-[18px]">
                  Target
                  <span class="font-bold text-[#FF7815]">Rp 25.000.000</span>
                </p>
              </div>
              <progress
                id="fund"
            ...
            >
              ...
              <div class="flex flex-col gap-[6px]">
                <a
                  href="details.html"
                  class="font-bold line-clamp-2 hover:line-clamp-none"
                  >Banjir 10 Meter Kota Saranjopa Iyola</a
                >
                <p class="text-xs leading-[18px]">
                  Target
                  <span class="font-bold text-[#FF7815]">Rp 12.000.000</span>
                </p>
              </div>
              <progress
                id="fund"
            ...
            >
              ...
              <div class="flex flex-col gap-[6px]">
                <a
                  href="details.html"
                  class="font-bold line-clamp-2 hover:line-clamp-none"
                  >Perbaikan Asli Kebakaran Hutan</a
                >
                <p class="text-xs leading-[18px]">
                  Target
                  <span class="font-bold text-[#FF7815]">Rp 800.000.000</span>
