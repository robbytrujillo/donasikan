                ...
                @forelse ($fundraising_withdrawals as $withdrawal)
                    <div class="flex flex-row items-center justify-between item-card">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-indigo-950">Rp {{ number_format($withdrawal->amount_requested, 0, ',', '.') }}</h3>
                        </div>
                        <div>
                        ...
                        <div class="flex-col hidden md:flex">
                            ...
                            <h3 class="text-xl font-bold text-indigo-950">{{ $withdrawal->fundraiser->user->name }}</h3>
                        </div>
                        ...
                        <div class="flex-row items-center hidden md:flex gap-x-3">
                            <a href="{{ route('admin.fundraising_withdrawals.show', $withdrawal) }}" class="px-6 py-4 font-bold text-white bg-indigo-700 rounded-full">
                                View Details
                            </a>
                        </div>
                    </div>    
