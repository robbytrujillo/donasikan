<x-app-layout>
    ...
    @role('owner')
        <div class="py-12 list-fundraisers">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex flex-col p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg gap-y-5">
                        ...
                        <div class="flex flex-row items-center justify-between item-card">
                            <div class="flex flex-row items-center gap-x-3">
                                ...
                                <div class="flex flex-col">
                                    <h3 class="text-xl font-bold text-indigo-950">{{ $fundraiser->user->name }}</h3>
                                </div>
                            </div> 
                            <div class="flex-col hidden md:flex">
                                <p class="text-sm text-slate-500">Date</p>
                                <h3 class="text-xl font-bold text-indigo-950">{{ $fundraiser->created_at->format('M d, Y') }}</h3>
                            </div>
                    ...
                    @empty
                        <p>
                            Belum ada apply fundriser terbaru
                        </p>
                    @endforelse
        ...
        <div class="py-12 list-fundraisers">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex flex-col p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg ">
                    <div class="flex flex-col items-center justify-between item-card gap-y-5">
                        <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div class="flex flex-col text-center">
                            <h3 class="text-xl font-bold text-indigo-950">Tebarkan Kebaikan</h3>
                            <p class="text-base text-slate-500">Jadilah bagian dari kami untuk membantu <br>mereka yang membutuhkan dana tambahan</p>
                        </div>
